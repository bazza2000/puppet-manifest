class node::svc::perf {
  ...
  each($was_envs) |$was_env| {
    ...
    websphere_application_server::profile::appserver { "nf_svc_node_${was_env}_01":
      ...
      dmgr_host      => "${dmgr_host}",
      node_name      => "nf_svc_node_${was_env}_01",
    } ->
    websphere_application_server::cluster { "nf_svc_${was_env}_01_01_cl":
      profile_base => "/opt/IBM/${was_env}/WebSphere85/profiles",
      dmgr_profile => "nf_svc_node_${was_env}_01",
      cell         => "nf_svc_mgr_${was_env}_cell",
    } ->
    websphere_application_server::cluster::member { "nf_svc_${was_env}_01_01":
      ensure                           => 'present',
      cluster                          => "nf_svc_${was_env}_01_01_cl",
      node                             => "nf_svc_node_${was_env}_01",
      cell                             => "nf_svc_mgr_${was_env}_cell",
    ...
    websphere_application_server::cluster::member { "nf_svc_${was_env}_01_02":
      ensure                           => 'present',
      cluster                          => "nf_svc_${was_env}_01_01_cl",
      node                             => "nf_svc_node_${was_env}_01",
      cell                             => "nf_svc_mgr_${was_env}_cell",
